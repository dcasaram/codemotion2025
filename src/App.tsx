  ...
  return (
    <div className="flex flex-col items-center justify-center font-roboto">
      <div className="h-screen flex flex-col gap-6 items-center justify-center text-white bg-dark w-full relative z-1">
        <h1 className="text-6xl font-bold text-vodafone font-golos">#codemotion2025</h1>
        <p>Lo que pasa en el Codemotion, se queda en... el Web Guild!</p>
        <img src="/team.png" alt="Equipazo!" className="w-[420px] h-[420px] rounded-full mt-8" />
      </div>
      <div className="py-40 px-12 box-content relative min-h-screen max-w-[1280px] mx-auto">
        ...
        <ul className="w-[50%] left-[50%] flex flex-col gap-16">
          {elements.map((element, index) => (
            <li key={element.title} className="relative transform odd:translate-x-[100%] pr-12 odd:pr-0 odd:pl-12 before:content-[''] before:absolute before:w-[11px] before:h-[11px] before:bg-dark before:top-4 before:rounded-full before:transform before:-translate-[50%] before:left-[100%] odd:before:-translate-[50%] odd:before:left-[0] odd:[&>div:first-child]:-translate-x-[100%] even:[&>div:first-child]:translate-x-[100%] h-[70dvh] odd:[&>div:last-child]:left-12 odd:[&>div:last-child]:right-0 even:[&>div:last-child]:left-0 even:[&>div:last-child]:right-12 [&:marker]:opacity-0">
              <div className={states[index] ? imageClasses.visible : imageClasses.hidden}>
                <img className="max-h-60 h-full rounded-2xl" src={`/img-${index + 1}.gif`} alt="" />
              </div>
              <button className="text-left w-full cursor-pointer transform duration-500 hover:text-vodafone hover:translate-x-4 transition-all" onClick={() => handleClick(index)}>
                <h2 className="font-bold font-golos text-2xl">{element.title}</h2>
              </button>
              <span className="font-bold text-gray-600 text-sm mt-1 mb-3 block">{element.speaker}</span>
              <div dangerouslySetInnerHTML={{ __html: element.description }} />
              <div className={states[index] ? resumeClasses.visible : resumeClasses.hidden}>
